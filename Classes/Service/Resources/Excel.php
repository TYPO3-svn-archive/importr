...
class Excel extends AbstractResource implements ResourceInterface {
	...
	public function parseResource() {
		...
		if (!\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('phpexcel_library'))
			throw new \Exception('phpexcel_library is not loaded', 12367812368);

		$filename = \TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName($this->filepath);
