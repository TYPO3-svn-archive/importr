 ...
 */
class Tx_Importer_Service_Resources_Csv extends Tx_Importer_Service_Resources_AbstractResource implements Tx_Importer_Service_Resources_ResourceInterface {
	...
	public function parseResource() {
		...
		if (($handle = fopen(t3lib_div::getFileAbsFileName($this->filepath), "r")) !== FALSE) {
			$row = 0;
