...
class ImportRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	public function findUserQueue($days = 7) {
		...
		$query->setOrderings(array('starttime' => \TYPO3\CMS\Extbase\Persistence\Generic\Query::ORDER_DESCENDING));
	...
	public function findWorkQueue() {
		...
		$query->setOrderings(array('starttime' => \TYPO3\CMS\Extbase\Persistence\Generic\Query::ORDER_ASCENDING));
