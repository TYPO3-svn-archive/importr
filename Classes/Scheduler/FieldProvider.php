 ...
 */
class Tx_Importer_Scheduler_FieldProvider implements Tx_Scheduler_AdditionalFieldProvider {
	...
	/**
	 * @var Tx_Importer_Scheduler_Task
	 */
	protected $task;
	 ...
	 * @param mixed $task Tx_Importer_Scheduler_Task or tx_scheduler_Execution instance
